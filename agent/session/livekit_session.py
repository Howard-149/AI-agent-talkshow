"""Construct AgentSession with Silero VAD, Gemma STT, StoredReplyLLM, and TTS."""
...
from agent.adapters import GemmaAudioSTT, StoredReplyLLM
from agent.adapters.tts_factory import build_tts_from_config
