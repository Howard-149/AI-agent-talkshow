"""Panel roster helpers: speaker roles, name lists, next-tag options, welcome lines."""
...
def session_welcome_texts(scenario: ScenarioConfig | None = None) -> dict[str, str]:
    """Canned en/zh welcome lines (no Gemma translate — opening must not race/fail)."""
    return {
        "en": session_welcome_line(scenario, locale="en"),
        "zh": session_welcome_line(scenario, locale="zh"),
    }
